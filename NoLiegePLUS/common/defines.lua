...
NOMINATE_CROWN_BISHOP_PIETY_COST = 15, 					-- OBSOLETE
	...
	MATERNITY_DEATH_CHANCE = 0.03,					-- Chance of the mother dying in labor
...
-- Title Grant Decadence Reduction (Multiplied with current decadence)
	...
	CLAIM_VASSAL_TITLE_COST_MOD = 3,
	CLAIM_DE_JURE_TITLE_COST_MOD = 2,
...
NReligion = {
	...
	KINGDOM_CREATION_PIETY_COST = 50,
	EMPIRE_CREATION_PIETY_COST = 100,
...
NDecadence = {
	...
	EMPEROR_HOLDING_REDUCTION = 0,
	KING_HOLDING_REDUCTION = 0,
	DUKE_HOLDING_REDUCTION = 0,
	COUNT_HOLDING_REDUCTION = 0,
	BARON_HOLDING_REDUCTION = 0,
	HAS_JOB_REDUCTION = 0,
	ON_JOB_REDUCTION = 0,
...
NMilitary = {
	...
	PAGAN_HOME_SUPPLY_MOD = 0.25,					-- Non Pagans suffer extreme attrition in some Pagan homelands (based on province religion)
